...
def main():
    ...
    fragments.add_string("hour","hour ")
    fragments.add_string("minute", "minute ")
    fragments.add_string("set", "set ")
    fragments.add_string("day", "day ")
    fragments.add_string("month", "month ")
    fragments.add_string("year", "year ")
